...
export const SIGNOS = [
  { id: 'aries',       nombre: 'Aries',       inicio: 0,   fin: 30,  elemento: 'fuego', modalidad: 'cardinal' },
  { id: 'tauro',       nombre: 'Tauro',       inicio: 30,  fin: 60,  elemento: 'tierra', modalidad: 'fijo'    },
  { id: 'geminis',     nombre: 'Géminis',     inicio: 60,  fin: 90,  elemento: 'aire',  modalidad: 'mutable'  },
  { id: 'cancer',      nombre: 'Cáncer',      inicio: 90,  fin: 120, elemento: 'agua',  modalidad: 'cardinal' },
  { id: 'leo',         nombre: 'Leo',         inicio: 120, fin: 150, elemento: 'fuego', modalidad: 'fijo'     },
  { id: 'virgo',       nombre: 'Virgo',       inicio: 150, fin: 180, elemento: 'tierra', modalidad: 'mutable' },
  { id: 'libra',       nombre: 'Libra',       inicio: 180, fin: 210, elemento: 'aire',  modalidad: 'cardinal' },
  { id: 'escorpio',    nombre: 'Escorpio',    inicio: 210, fin: 240, elemento: 'agua',  modalidad: 'fijo'     },
  { id: 'sagitario',   nombre: 'Sagitario',   inicio: 240, fin: 270, elemento: 'fuego', modalidad: 'mutable'  },
  { id: 'capricornio', nombre: 'Capricornio', inicio: 270, fin: 300, elemento: 'tierra', modalidad: 'cardinal' },
  { id: 'acuario',     nombre: 'Acuario',     inicio: 300, fin: 330, elemento: 'aire',  modalidad: 'fijo'     },
  { id: 'piscis',      nombre: 'Piscis',      inicio: 330, fin: 360, elemento: 'agua',  modalidad: 'mutable'  },
];
